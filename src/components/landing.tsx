...
const Main = () => {
	return (
		<a href="/faculty" className="flex flex-col relative justify-center items-center py-6 max-w-md mx-auto my-auto bg-gradient-to-b from-[#e6e6e6] via-[#ffffff] to-[#e6e6e6] rounded-xl shadow-md h-dvh">
