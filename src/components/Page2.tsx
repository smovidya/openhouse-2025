...
export const Page2 = () => {
	...
	return (
		<div className="flex flex-col items-center relative py-[70px] bg-plan max-w-md mx-0 my-auto rounded-xl bg-cover bg-top overflow-x-hidden h-dvh w-full overflow-hidden bg-no-repeat">
